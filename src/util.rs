...
///
/// use mellophone_lib::util::parse_le_u32_flags;
///
/// bitflags! {
...
/// }
/// ```
pub fn parse_le_u32_flags<F>(input: &[u8]) -> IResult<&[u8], F>
where
...
pub fn map_read_error(read_err: std::io::Error, expected_size: usize) -> LoadTextureError {
    match read_err.kind() {
